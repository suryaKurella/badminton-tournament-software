...
import { Users, Trophy, Lock, Globe, Pencil, Trash2, UserPlus, UserMinus, Shield, Crown, Check, X } from 'lucide-react';
...
const ClubDetails = () => {
  ...
  return (
    <div className="w-full">
      ...
      {activeTab === 'tournaments' && (
        <div className="glass-card p-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Tournaments</h2>
          {club.tournaments?.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400">No tournaments yet</p>
          ) : (
            <div className="space-y-3">
