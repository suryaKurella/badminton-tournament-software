  ...
  return (
    <div className="w-full">
      <div className="mb-6 sm:mb-8 pb-4 border-b-2 border-gray-200 dark:border-slate-700">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-light-text-primary dark:text-white">Create Tournament</h1>
        <p className="text-light-text-muted dark:text-gray-400 mt-2 text-sm">Fill in the details to create a new tournament</p>
      </div>
