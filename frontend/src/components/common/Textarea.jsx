...
const Textarea = forwardRef(({
  ...
  const baseStyles = 'w-full px-4 py-3 border-2 border-gray-300 dark:border-slate-600 rounded-md text-sm transition-all bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:outline-none focus:border-blue-600 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900/30 resize-none';
